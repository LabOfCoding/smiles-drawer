 ...
 */
export declare class DrawerBase {
    graph: Graph | null;
    rings: Ring[];
    ...
    canvasWrapper: CanvasWrapper | null;
    totalOverlapScore: number;
    defaultOptions: any;
    opts: any;
    private doubleBondConfigCount;
    private doubleBondConfig;
    private bridgedRing;
     ...
     */
    getLargestOrAromaticCommonRing(vertexA: any, vertexB: any): Ring | null | undefined;
    /**
     ...
     */
    getClosestVertex(vertex: any): Vertex | null;
    /**
     ...
     */
    getRing(ringId: any): Ring | undefined;
    /**
     ...
     */
    getRingConnection(id: any): RingConnection | undefined;
    /**
    ...
    getOverlapScore(): {
        total: number;
        scores: any[];
        vertexScores: Float32Array<ArrayBuffer>;
    };
    /**
     ...
     */
    createRing(ring: any, center?: null, startVertex?: null, previousVertex?: null): void;
    /**
     ...
     */
    getLastVertexWithAngle(vertexId: any): Vertex | null;
    /**
     ...
     */
    createNextBond(vertex: any, previousVertex?: null, angle?: number, originShortest?: boolean, skipPositioning?: boolean): void;
    /**
     ...
     */
    getCommonRingbondNeighbour(vertex: any): Vertex | null;
    /**
     ...
     */
    getEdgeNormals(edge: any): [Vector2, Vector2];
    /**
