...
export declare class Graph {
     ...
     */
    constructor(parseTree: ParseTreeNode, isomeric?: boolean);
    /**
     ...
     */
    getComponentsAdjacencyMatrix(): AdjacencyMatrix;
    /**
     ...
     */
    getSubgraphAdjacencyMatrix(vertexIds: number[]): AdjacencyMatrix;
    /**
     ...
     */
    getSubgraphDistanceMatrix(vertexIds: number[]): DistanceMatrix;
    /**
     ...
     */
    getSubgraphAdjacencyList(vertexIds: number[]): AdjacencyList;
    /**
     ...
     */
    traverseTree(vertexId: number, parentVertexId: number | null, callback: (vertex: Vertex) => void, maxDepth?: number, ignoreFirst?: boolean, depth?: number, visited?: Uint8Array | null): void;
    /**
     ...
     */
    kkLayout(vertexIds: number[], center: Vector2, startVertexId: number, ring: Ring, bondLength: number, threshold?: number, innerThreshold?: number, maxIteration?: number, maxInnerIteration?: number, maxEnergy?: number): void;
    /**
     ...
     */
    static getConnectedComponents(adjacencyMatrix: AdjacencyMatrix): number[][];
    /**
     ...
     */
    static getConnectedComponentCount(adjacencyMatrix: AdjacencyMatrix): number;
    /**
     * PRIVATE FUNCTION used by getConnectedComponentCount().
     */
    private static _ccCountDfs;
    /**
     * PRIVATE FUNCTION used by getConnectedComponents().
     */
    private static _ccGetDfs;
}
